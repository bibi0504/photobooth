...
export default function Generate() {
  ...
  const Sticker = () => {
    if (persona?.subText) {
      ...
      return (
        <PersonaText
          className={styles.sticker + (color.isBlack ? " black" : " white")}
        />
      );
    }
    return (
              ...
              <div className={styles.selfieCard} ref={cardRef}>
                ...
                >
                  ...
                  {repositionedImage ? (
                    ...
                    >
                      <img
                        src={repositionedImage}
                        alt=""
                        className={styles.repositionedImage}
                      />
                    </div>
                  ) : (
                  ...
                  <div
                    ...
                    style={getBackgroundAndTextColor()}
                  >
            ...
            {isDownload ? (
              ...
              <div className={styles.rightContainer}>
                ...
                <p className={styles.desc}>
                  Start with a photo then follow the steps below to personalize
                  your meme.
                </p>
