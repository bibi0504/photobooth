          ...
          <div className={styles.mainContent}>
            ...
            {isDownload ? (
              ...
              <div className={styles.rightContainer}>
                ...
                <p className={styles.desc}>Start with a photo then follow the steps below to personalize your meme.</p>
          ...
          {step === 1 ? (
            ...
            <div className={styles.titleContainer}>
              <p className={styles.modalTitle}>
                {step === 2 ? 'Position your selfie' : step === 3 ? 'Pick your persona' : 'Select a color'}
              </p>
