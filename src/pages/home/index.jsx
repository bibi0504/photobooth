        ...
        <div className={styles.bodyContainer}>
          <div className={styles.bodyContent}>
            <div className={styles.leftContainer}>
              ...
              <p className={styles.info}>
                Choose your persona and pair it with one of our vibrant new brand colors and a lighthearted statement
                about our business to create a fun meme celebrating the Newfront brand launch.
              </p>
            ...
            <div className={styles.rightContainer}>
              <img id="CardImg" src={Social} alt="card" ref={cardRef} className={styles.imageStyle} />
            </div>
          </div>
        </div>
      </div>
